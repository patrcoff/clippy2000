...
class App():
    ...
    def hide_window(self,win,commands):
    ...
    def run_app(self):
        ...
        self.win.protocol('WM_DELETE_WINDOW', partial(self.hide_window,self.win,commands))#when window is closed by user, the hide_window function runs (the systray function)
